  ...
  return (
    <div className="flex gap-2 items-center ">
      <div className="flex items-start">
        ...
        <textarea
          className="flex-1 appearance-none border border-gray-300 w-full py-2 px-4 bg-white text-gray-700 placeholder-gray-400 rounded-r-lg text-base focus:outline-none focus:ring-2  focus:border-transparent"
          id="comment"
